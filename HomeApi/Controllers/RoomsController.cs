...
namespace HomeApi.Controllers
{
    ...
    public class RoomsController : ControllerBase
    {
            ...
            [FromBody]  EditRoomRequest request)
        {
            ...
            var withSameName = await _repository.GetRoomByNameExceptId(id, request.NewName);
            ...
            await _repository.UpdateRoom(
                room,
                new UpdateRoomQuery(request)
            );

            return StatusCode(200, $"Комната {room.Name} с Id '{room.Id}' обновлена!");
        }
    }
}
